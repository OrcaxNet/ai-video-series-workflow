...
func run(ctx context.Context, args []string, stderr io.Writer, lookup func(string) (string, bool)) error {
	...
	flags.StringVar(&files.AnalyzerRoot, "analyzer-root", "", "FLO-154 sealed analyzer artifact root")
	flags.StringVar(&files.AnalyzerSeal, "analyzer-seal", "", "FLO-154 analyzer seal JSON")
